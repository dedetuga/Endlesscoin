...
#if defined(NDEBUG)
# error "EndessCoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "EndessCoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s NDLS additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("endlesscoin-scriptch");
