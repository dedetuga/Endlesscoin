...
#ifndef ENDLESSCOIN_TEST_SCRIPTNUM10_H
#define ENDLESSCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from EndessCoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // ENDLESSCOIN_TEST_BIGNUM_H
