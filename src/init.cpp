 ...
 * between endlesscoind, and endlesscoin-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("endlesscoin-shutoff");
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), ENDLESSCOIN_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/dedetuga/Endlesscoin>";
    const std::string URL_WEBSITE = "<https://endlesschains.000webhostapp.com>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("endlesscoin-loadblk");
...
/** Sanity checks
 *  Ensure that EndessCoin is running in a usable environment with all
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("EndessCoin version %s\n", FormatFullVersion());
}
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single EndessCoin process is using the data directory.
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", ENDLESSCOIN_CONF_FILENAME)).string());
