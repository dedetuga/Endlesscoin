...
#ifndef ENDLESSCOIN_WALLET_WALLET_H
#define ENDLESSCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this endlesscoin node, and set to 0 for transactions that were created
...
#endif // ENDLESSCOIN_WALLET_WALLET_H
