...
###   endlesschains.000webhostapp.com and endlesscoin.org and compares them.
...
if [ $? -ne 0 ]; then
   echo "endlesscoin.org failed to provide signature file, but endlesschains.000webhostapp.com did?"
   echo "wget output:"
   echo "$WGETOUT"|sed 's/^/\t/g'
...
if [ "$SIGFILEDIFFS" != "" ]; then
   echo "endlesscoin.org and endlesschains.000webhostapp.com signature files were not equal?"
