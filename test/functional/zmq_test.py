...
class ZMQTest (EndessCoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that endlesscoin has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("endlesscoind has not been built with zmq enabled.")
