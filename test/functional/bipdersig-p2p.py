...
class BIP66Test(EndessCoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # endlesscoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and endlesscoind produces more specific reject
            # reasons.
