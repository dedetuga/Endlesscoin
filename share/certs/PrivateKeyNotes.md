...
unlocked to sign the EndessCoin-Qt.app bundle.
...
allowing somebody to distribute a EndessCoin-Qt.app or endlesscoin-qt-setup.exe with a valid
...
that the endlesscoin-qt.exe file inside the installer had not been tampered with.
