...
space *do not upload these to the endlesscoin.org server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the endlesscoin.org server
...
people without access to `endlesscoin.org` to download the binary distribution.
Also put it into the `optional_magnetlink:` slot in the YAML file for
endlesscoin.org (see below for endlesscoin.org update instructions).

- Update endlesscoin.org version

  - First, check to see if the EndessCoin.org maintainers have prepared a
    release: https://github.com/endlesscoin-dot-org/endlesscoin.org/labels/Releases
  ...
  - If they have not prepared a release, follow the EndessCoin.org release
    instructions: https://github.com/endlesscoin-dot-org/endlesscoin.org#release-notes
