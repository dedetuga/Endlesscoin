Download URL: https://sourceforge.net/projects/endlesscoin/files/EndessCoin/endlesscoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 NDLS fee schedule (users still pay 0.01 NDLS per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #endlesscoin00 - #endlesscoin99
