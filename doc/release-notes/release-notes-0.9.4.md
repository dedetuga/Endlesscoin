EndessCoin Core version 0.9.4 is now available from:

  https://endlesscoin.org/bin/0.9.4/
...
this update is incompatible with the EndessCoin system and could lead to consensus
forks.

EndessCoin Core released binaries from https://endlesscoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~endlesscoin/+archive/ubuntu/endlesscoin
- A third-party or self-compiled EndessCoin Core

upgrade to EndessCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
