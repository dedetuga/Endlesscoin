EndessCoin Core version 0.13.2 is now available from:

  <https://endlesscoin.org/bin/endlesscoin-core-0.13.2/>
...
- #8908 `4a974b2` Update endlesscoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow endlesscoin-tx to create v2 transactions (btcdrak)
