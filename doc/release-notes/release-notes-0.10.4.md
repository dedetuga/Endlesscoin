EndessCoin Core version 0.10.4 is now available from:

  <https://endlesscoin.org/bin/endlesscoin-core-0.10.4/>
...
- #6953 `43c2789` Split endlesscoin-tx into its own package
- #6953 `dfe0d4d` Include endlesscoin-tx binary on Debian/Ubuntu
