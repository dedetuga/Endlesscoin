EndessCoin Core version 0.9.2.1 is now available from:

  https://endlesscoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 NDLS to 0.01 NDLS
...
- Fix "Start endlesscoin on system login"
