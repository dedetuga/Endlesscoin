EndessCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/endlesscoin/files/EndessCoin/endlesscoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the EndessCoin
...
New/changed settings (command-line or endlesscoin.conf file)
--------------------------------------------------------
