EndessCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/endlesscoin/files/EndessCoin/endlesscoin-0.5.4/
...
http://gitorious.org/endlesscoin/endlesscoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix EndessCoin-Qt notifications under Growl 1.3.
Increase required age of EndessCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxEndessCoin properly when installing EndessCoin-Qt over it. (Windows)
